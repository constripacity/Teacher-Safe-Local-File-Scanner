...
This package exposes lightweight detectors that avoid executing untrusted
content. Modules provide both legacy heuristics and new rule-based analyses
used by the v0.1 release pipeline.
"""
...
from .. import utils
from .image_rules import analyze_image
from .office_rules import analyze_office
from .pdf_rules import analyze_pdf
from .zip_rules import analyze_zip
...
def _issue(code: str, description: str, evidence: str | None = None) -> Dict[str, str]:
    issue: Dict[str, str] = {"code": code, "description": description}
...
__all__ = [
    ...
    "detect_image_appended_data",
    "detect_office_macro",
    "detect_pdf_risks",
    "detect_pe_headers",
    "detect_zip_contents",
    "extract_urls_and_flag",
]
